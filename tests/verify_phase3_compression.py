...
test_files = [
    {
        "file_path": "D:\\Sanctum\\Flamehaven-Filesearch\\flamehaven_filesearch\\engine\\embedding_generator.py",  # noqa: E501
    ...
    {
        "file_path": "D:\\Sanctum\\Flamehaven-Filesearch\\tests\\test_gravitas_cache_integration.py",  # noqa: E501
...
print(
    f'  Effective reduction:          {(stats["bytes_saved"]/total_original)*100:.1f}%'
)
